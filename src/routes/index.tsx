  ...
  export const Route = createFileRoute("/")({
    head: () => {
      ...
      const ogImageUrl = domain ? `${domain}/shajahan-shibina-couple.jpeg` : "/shajahan-shibina-couple.jpeg";
  ...
  const WEDDING_DATE = new Date("2026-11-29T11:30:00+05:30").getTime();
  const WEDDING_MAPS_URL =
    "https://www.google.com/maps/search/?api=1&query=N.I.C.+Center+Pallinada+Kaniyapuram";
  const NIKKAH_MAPS_URL =
    "https://www.google.com/maps/search/?api=1&query=Pallinada+Muslim+Jamahath+Kaniyapuram";
  const COUPLE_PORTRAIT = "/shajahan-shibina-couple.jpeg";
  const COUPLE_LANDSCAPE = "/shajahan-shibina-couple.jpeg";
  const HERO_BG = "/shajahan-shibina-couple.jpeg";
  const GALLERY_IMG_1 = "/shajahan-groom.jpeg";
  const GALLERY_IMG_2 = "/shibina-bride.jpeg";
    ...
    return (
      <div className={`wed-root ${opened ? "is-opened" : "is-closed"}`}>
        ...
        <section className="section families">
          ...
          <div className="family-grid" data-stagger>
            <article className="family-card" data-stagger-item>
              ...
              <p className="family-house">Kochu Veedu, Madanvila, Perumathura P. O</p>
        ...
        <section className="section event">
          ...
          <div className="event-list" data-stagger>
            <div className="event-card" data-stagger-item>
              <span className="event-badge">Pre-Wedding Reception</span>
              ...
              <div className="event-rows">
                <div className="event-row">
                  ...
                  <div>
                    <span>Date</span>
                    <strong>Saturday, 28 November 2026</strong>
                  </div>
                </div>
                <div className="event-row">
            ...
            <div className="event-card" data-stagger-item>
              <span className="event-badge">Nikkah</span>
              <h3 className="event-title">The Nikkah Ceremony</h3>
              <div className="line-divider small">
                <span>✦</span>
              </div>
              <div className="event-rows">
                <div className="event-row">
                  ...
                  <div>
                    <span>Date</span>
                    <strong>Sunday, 29 November 2026</strong>
                  </div>
                </div>
                <div className="event-row">
                  <i className="fa-regular fa-clock" />
                  <div>
                    <span>Time</span>
                    <strong>Between 11:30 AM &amp; 12:00 PM</strong>
                  </div>
                </div>
                <div className="event-row">
                  ...
                  <div>
                    <span>Venue</span>
                    <strong>Pallinada Muslim Jamahath</strong>
                  </div>
                </div>
              </div>
            ...
            <div className="event-card" data-stagger-item>
              <span className="event-badge">Wedding</span>
              <h3 className="event-title">The Wedding Ceremony</h3>
              <div className="line-divider small">
                <span>✦</span>
              </div>
              <div className="event-rows">
                ...
                <div className="event-row">
                  ...
                  <div>
                    <span>Venue</span>
                    <strong>N.I.C. Center, Pallinada, Kaniyapuram</strong>
                  </div>
                </div>
              </div>
              <div className="event-actions">
        ...
        <section className="section gallery">
          ...
          <div className="gallery-grid" data-stagger>
            <figure className="gal-frame tall" data-stagger-item>
              <img src={COUPLE_PORTRAIT} alt="Shajahan and Shibina together" />
              <div className="gal-hover-overlay" />
            </figure>
            <figure className="gal-frame" data-stagger-item>
              <img src={GALLERY_IMG_1} alt="Shajahan, the groom" />
              <div className="gal-hover-overlay" />
            </figure>
            <figure className="gal-frame" data-stagger-item>
              <img src={GALLERY_IMG_2} alt="Shibina, the bride" />
              <div className="gal-hover-overlay" />
            </figure>
          </div>
        </section> */}
        ...
        <footer className="wed-footer">
          ...
          <p className="footer-thanks">With Best Compliments From</p>
          <p className="footer-msg">
            Your presence and prayers on our special day are the greatest gift we
            could ask for.
          </p>
          <p className="footer-couple">Shabin Zidan</p>
        </footer>
