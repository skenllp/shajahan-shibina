...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "You are cordially invited to the wedding of Shajahan & Shibina on 29 November 2026 at N.I.C. Center, Pallinada, Kaniyapuram." },
      { property: "og:title", content: "Shajahan & Shibina — Wedding Invitation" },
      { property: "og:description", content: "You are cordially invited to the wedding of Shajahan & Shibina on 29 November 2026 at N.I.C. Center, Pallinada, Kaniyapuram." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/og-image.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Shajahan & Shibina — Wedding Invitation" },
      { name: "twitter:description", content: "You are cordially invited to the wedding of Shajahan & Shibina on 29 November 2026 at N.I.C. Center, Pallinada, Kaniyapuram." },
